...
if(isset($_POST['save'])){
    ...
    //     $errorMsg = !empty($errorUpload)?'<br/>'.$errorUpload.'<br/>'.$errorUploadType:'<br/>'.$errorUploadType; 
        ...
        // if(!empty($insertValuesSQL)){ 
            ...
            $insert = $conn->query("INSERT INTO blog_two(blog, blog_pic) VALUES ('$editorContent','$fileName')"); 
            if($insert){ 
...
<div class="home_wrapper">
   ...
   <input type="submit"value="Save"class="btn btn-primary"style="margin-top:15px"name="save">
    ...
    <div class="part_b">
<button class="btn btn-info"style="color:#FFFFFF;margin-bottom:15px;margin-top:15px;"><a href="home.php?link=<?php echo 'home' ?>"style="color:#FFFFFF">BLOG 1</a></button>
<a href="../index.php"><button class="btn btn-info"style="color:#FFFFFF"><i class="fa fa-globe"></i> Visit</button></a>
<button class="btn btn-info"style="color:#FFFFFF"><i class="fa fa-eye"></i><a href="home.php?link=<?php echo 'blog2' ?>"style="color:#FFFFFF"> View</a></button>
    </div>
